...
.mobile-pdf-container{display:flex;flex-direction:column;align-items:center;gap:4px;width:100%}
.mobile-pdf-loading{display:flex;flex-direction:column;align-items:center;gap:12px;padding:60px 20px;color:#737373;font-size:14px}
.pdf-loading-spinner{width:32px;height:32px;border:3px solid #e5e5e5;border-top-color:#171717;border-radius:50%;animation:syncSpin 0.8s linear infinite}
.pdf-page-canvas{display:block;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,0.12);border-radius:4px;margin-bottom:6px}
